...
<head>
    ...
    <title>Nikah Masnoon - A leading muslim matrimony in India</title>
...
<body>
    <aside class="sidebar">
        ...
        <div class="sidebar-menu-area">
            <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <li class="sidebar-menu-group-title">Tools</li>

                <li>
                    <a href="{{url('/tools/profile-for')}}">
                        <iconify-icon icon="solar:pie-chart-outline" class="menu-icon"></iconify-icon>
                        <span>Profile for</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/tools/caste')}}">
                        <iconify-icon icon="solar:document-text-outline" class="menu-icon"></iconify-icon>
                        <span>Caste</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/tools/maslaq')}}">
                        <iconify-icon icon="heroicons:document" class="menu-icon"></iconify-icon>
                        <span>Maslaq</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/tools/family-type')}}">
                        <iconify-icon icon="heroicons:document" class="menu-icon"></iconify-icon>
                        <span>Family Type</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/tools/marital-status')}}">
                        <iconify-icon icon="mingcute:storage-line" class="menu-icon"></iconify-icon>
                        <span>Marital Status</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/tools/occupation')}}">
                        <iconify-icon icon="fe:vector" class="menu-icon"></iconify-icon>
                        <span>Occcupation</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/tools/qualification')}}">
                        <iconify-icon icon="flowbite:users-group-outline" class="menu-icon"></iconify-icon>
                ...
                <li>
                    <a href="{{url('/tools/employeed-in')}}">
                        <i class="ri-user-settings-line"></i>
                        <span>Employeed In</span>
                    </a>
                </li>
    ...
    <main class="dashboard-main">
        ...
        <footer class="d-footer">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <p class="mb-0">© 2024 NikahMasnoon. All Rights Reserved.</p>
                </div>
                <div class="col-auto">
                    <p class="mb-0">Made by <span class="text-primary-600">Digital Nawab</span></p>
                </div>
            </div>
        </footer>
    </main>
